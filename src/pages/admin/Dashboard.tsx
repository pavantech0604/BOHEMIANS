    ...
    <AdminLayout>
      <div className="space-y-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          >
            <Card className="bg-primary text-on-primary p-10 h-full flex flex-col justify-between shadow-2xl shadow-primary/20 relative overflow-hidden group">
              <div className="relative z-10">
                <Banknote size={40} className="mb-6 opacity-80" />
                <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-60">Today's Revenue</p>
                <h3 className="text-5xl font-black font-headline tracking-tighter mt-2 leading-none">₹82,482.00</h3>
              </div>
              <div className="mt-8 flex items-center gap-2 z-10 text-xs font-black uppercase tracking-widest">
                <TrendingUp size={16} />
                <span>+14.2% from yesterday</span>
              </div>
              <Banknote size={240} className="absolute -right-16 -bottom-16 opacity-10 group-hover:scale-110 transition-transform duration-1000" />
            </Card>
          </motion.div>
          ...
          <motion.div 
            ...
            className="md:col-span-4"
          >
            <Card className="bg-secondary text-on-secondary p-10 h-full flex flex-col justify-between shadow-2xl shadow-secondary/20 relative overflow-hidden group">
              <div className="relative z-10">
                <Table2 size={40} className="mb-6 opacity-80" />
                <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-60">Total Reservations</p>
                <h3 className="text-5xl font-black font-headline tracking-tighter mt-2 leading-none">142</h3>
              </div>
              <p className="mt-8 text-xs font-black uppercase tracking-widest z-10">88% Capacity for average service</p>
              <Table2 size={240} className="absolute -right-16 -bottom-16 opacity-5 group-hover:scale-110 transition-transform duration-1000" />
            </Card>
          </motion.div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-12 lg:col-span-8">
            <Card variant="lowest" className="p-10 shadow-sm border border-stone-200/20 h-full">
              ...
              <div className="grid grid-cols-6 gap-8 h-96 relative">
                <div className="col-span-2 grid grid-cols-2 gap-4">
                  {[1, 2, 3, 4].map(n => (
                    <div 
                      key={n}
                      className={`${n % 2 === 1 ? 'bg-primary text-on-primary' : 'bg-surface-container-high text-on-surface/30'} aspect-square rounded-2xl flex flex-col items-center justify-center transition-all hover:scale-105 cursor-pointer`}
                    >
                ...
                <div className="col-span-4 bg-surface-container-low rounded-3xl p-8 grid grid-cols-4 gap-6 border-2 border-stone-200/20">
                ...
                <div className="absolute bottom-4 right-4 bg-secondary text-on-secondary rounded-2xl px-8 py-4 flex items-center gap-6 shadow-2xl">
                   <div className="font-headline font-black text-xs uppercase tracking-[0.2em]">Bar Lounge</div>
        ...
        {/* Promotion Highlight */}
        <section className="bg-stone-950 rounded-[4rem] p-16 text-surface relative overflow-hidden group">
          <div className="grid md:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              <span className="text-primary font-black uppercase tracking-[0.4em] text-xs">Marketing & Events</span>
              <h2 className="font-headline text-6xl font-black tracking-tighter mt-8 leading-[0.85]">THE ELECTRIC <br /> NEON NIGHTS</h2>
              <p className="text-stone-400 mt-8 text-lg max-w-md leading-relaxed opacity-80">Boost Tuesday revenue by launching the "Electric Hours" drink promotion. Predicted growth: +18%.</p>
              <div className="mt-12 flex gap-6">
                <button className="bg-surface text-stone-950 px-10 py-5 rounded-full font-black uppercase text-xs tracking-[0.2em] shadow-2xl hover:bg-white hover:scale-105 transition-all">
                  Launch Campaign
                </button>
                <button className="border border-surface/20 px-10 py-5 rounded-full font-black uppercase text-xs tracking-[0.2em] hover:bg-surface/10 transition-all">
                  View Assets
                </button>
              </div>
            </div>
          ...
          <div className="absolute top-0 right-0 font-headline font-black text-[300px] leading-none text-white/5 pointer-events-none select-none -translate-y-20 translate-x-20">BHM</div>
        </section>
      </div>
    </AdminLayout>
  );
